...
#             mid = mid - 1
#             m_order = pick_order_number(master_lines[mid])
#         # print('mid='+str(mid) + ' m_order='+str(m_order))
...
#     files_list = []
#     # for i in range(1, 96):
#     #     files_list.append('output/sod_'+str(i)+'.tra')
#     files_list.append('output/sod_2.tra')
#     merge_multi_file('output/dialog_master.tra', files_list, 'dialog_merge.tra')